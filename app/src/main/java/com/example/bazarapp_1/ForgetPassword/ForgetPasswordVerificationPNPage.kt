...
@Composable
fun ForgetPasswordVerificationPNScreen(modifier: Modifier = Modifier) {
    Box(
        modifier = Modifier
            .fillMaxSize()
        ...
        ContinueButtonForgetVerificationPhoneNum()
    }
}
...
@Composable
fun ContinueButtonForgetVerificationPhoneNum(modifier: Modifier = Modifier) {
    Button(
