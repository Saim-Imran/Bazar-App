...
@Composable
fun ForgetPasswordVerificationCodeEmailScreen(modifier: Modifier = Modifier) {
    Box(
        modifier = Modifier
            .fillMaxSize()
        ...
        ResendCodeEmailVeri()
        ContinueButtonForgetVerificationEmail()
    }
}
...
@Composable
fun ContinueButtonForgetVerificationEmail(modifier: Modifier = Modifier) {
    Button(
...
@Preview
@Composable
private fun ForgetPassVariPrew() {
    ForgetPasswordVerificationCodeEmailScreen()
}